...
#
    ...
    private function authenticate()
    {
        ...
        if ($this->isOK) {
            $this->isOK = isset($_POST['lti_version']) && ($_POST['lti_version'] == self::LTI_VERSION || $_POST['lti_version'] == self::LTI_VERSION_ALT);
        }
        if ($this->isOK) {
...
class LTI_User
{
    ...
    {
        return ($this->hasRole('Administrator') || $this->hasRole('administrator') || $this->hasRole('urn:lti:sysrole:ims/lis/SysAdmin') ||
        $this->hasRole('urn:lti:sysrole:ims/lis/Administrator') || $this->hasRole('urn:lti:instrole:ims/lis/administrator') || $this->hasRole('urn:lti:instrole:ims/lis/Administrator'));
    }
    ...
    {
        return ($this->hasRole('Instructor') || $this->hasRole('instructor') || $this->hasRole('contentdeveloper') || $this->hasRole('ContentDeveloper') || $this->hasRole('TeachingAssistant'));
    }
    ...
    {
        return ($this->hasRole('learner') || $this->hasRole('Learner'));
    }
